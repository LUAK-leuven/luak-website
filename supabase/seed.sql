...
-- Create some rentals
select public.create_rental('8c771dd8-fc00-40e4-b295-9fa8707612e5'::uuid, '49d86240-8648-4700-bcba-7f3a73d6d1de'::uuid, current_date, current_date, 20, 'transfer'::payment_method, '[{"gear_item_id": "c927a2f9-a477-451b-970a-bd548ad0278c", "rented_amount": 12}, {"gear_item_id": "6db74c8e-4f30-4da9-b119-442e536cae1f", "rented_amount": 1}]', '[]', null, 'A stupid comment'::text);
select public.create_rental('8c771dd8-fc00-40e4-b295-9fa8707612e5'::uuid, 'ebc0eb9c-e6a5-40ce-a4f4-4d4556ce78ea'::uuid, current_date, current_date, 50, 'transfer'::payment_method, '[{"gear_item_id": "3825a13b-0002-4d44-b7f8-e8d0d8730cd2", "rented_amount": 1}, {"gear_item_id": "6777b0e7-1b72-4572-821c-f0d7e7ed898c", "rented_amount": 1}, {"gear_item_id": "645702cc-5d7a-4c16-9a2a-027e5bcb40c3", "rented_amount": 1}]', '[{"topo_id": "539bca6e-417e-44b3-8e6a-fecf223b49a2", "rented_amount": 1}]', null, null);
select public.create_rental('8c771dd8-fc00-40e4-b295-9fa8707612e5'::uuid, null, current_date, current_date, 20, 'cash'::payment_method, '[{"gear_item_id": "661c9d36-e119-477b-8b4a-cb5348bb60c5", "rented_amount": 1}]', '[]', '{"fullName": "someone", "email": "my.contact@info.be", "phoneNumber": "1234"}', null);
